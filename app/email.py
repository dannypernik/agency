...
def send_confirmation_email(user, message):
    ...
    if result.status_code == 200:
        ...
        print("Confirmation email to " + user.email + " failed to send with code " + str(result.status_code, result.reason))
    return result.status_code
...
def send_verification_email(user):
    ...
    if result.status_code == 200:
        ...
        print("Verification email to " + user.email + " failed with code " + str(result.status_code))
    return result.status_code
